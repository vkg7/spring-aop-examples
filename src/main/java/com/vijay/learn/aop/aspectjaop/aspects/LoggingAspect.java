...
package com.vijay.learn.aop.aspectjaop.aspects;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.vijay.learn.aop.aspectjaop.BusinessLogic.getBusinessLogic(..))")
    ...
    @After("execution(* com.vijay.learn.aop.aspectjaop.BusinessLogic.getBusinessLogic(..))")
    ...
    @AfterReturning("execution(* com.vijay.learn.aop.aspectjaop.BusinessLogic.getBusinessLogic(..))")
    ...
    @AfterThrowing("execution(* com.vijay.learn.aop.aspectjaop.BusinessLogic.getBusinessLogic(..))")
    ...
    @Around("execution(* com.vijay.learn.aop.aspectjaop.BusinessLogic.getBusinessLogic(..))")
